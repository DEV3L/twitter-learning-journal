...
global_classification_model = {
    'engineering': {'iot', 'engineer', 'stranglerapplication', 'softwaredevelopment', 'nodejs', 'flask',
                    ...
                    'build', 'dom', 'css', 'jquery', 'angular', 'angular2', 'typescript', 'react',
                    },
    ...
    'agile': {'agile', 'definition', 'ready', 'done', 'experimentation', 'connection', 'doersdecide', 'demo',
              'agile2017', 'experiment', 'continuous',
    ...
    'product': {'productmanagement', 'prodmgmt', 'product', 'servicedesign', 'ux', 'cx', 'ui', 'orddesign',
                'productnerd', 'arch', 'productcraft', 'customerfirst', 'design', 'po', 'johncuttlefish'},
    'diversity': {'diversity', 'women', 'projectmanagement'},
