...
from app.twitter_learning_journal.services.logging_service import LoggingService, default_logging_format, default_level


# logging_format, get_logger, create_stream_handler, \
# _level, log_message
...
@patch('app.twitter_learning_journal.services.logging_service.LoggingService._build_stream_handler')
@patch('app.twitter_learning_journal.services.logging_service.logging')
